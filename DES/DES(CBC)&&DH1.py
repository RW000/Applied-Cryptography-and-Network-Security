...
def generate_large_prime_and_primitive_root():
    primes = list(primerange(10**3, 10**5))
...
if __name__ == "__main__":
    ...
    # 加密消息并写入encode.txt
    cbc_encode = md.encode_by_cbc(message, des_key=key, iv=iv)
    ...
    # 解密消息并写入decode.txt
    decrypted_message = md.decode_by_cbc(encrypted_message, des_key=key, iv=iv)
